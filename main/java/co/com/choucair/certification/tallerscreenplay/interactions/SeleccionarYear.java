...
public class SeleccionarYear implements Interaction {
    private Target lista;
    private String opcion;

    private SeleccionarYear(Target lista, String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    ...
    public static SeleccionarYear laLista(Target lista, String opcion) {
        return new SeleccionarYear(lista,opcion);
    }
