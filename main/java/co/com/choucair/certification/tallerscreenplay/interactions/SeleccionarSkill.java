...
public class SeleccionarSkill implements Interaction {
    private Target lista;
    private String opcion;

    private SeleccionarSkill(Target lista, String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    ...
    public static SeleccionarSkill laLista(Target lista, String opcion) {
        return new SeleccionarSkill(lista,opcion);
    }
