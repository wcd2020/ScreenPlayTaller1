...
public class SeleccionarMonth implements Interaction {
    private Target lista;
    private String opcion;

    private SeleccionarMonth(Target lista, String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    ...
    public static SeleccionarMonth laLista(Target lista, String opcion) {
        return new SeleccionarMonth(lista,opcion);
    }
