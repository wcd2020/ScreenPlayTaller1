...
public class SeleccionarSeleContry implements Interaction {

    private Target lista;
    private String opcion;

    private SeleccionarSeleContry(Target lista, String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    ...
    public static SeleccionarSeleContry laLista(Target lista, String opcion)
    {
        return new SeleccionarSeleContry(lista,opcion);
    }
