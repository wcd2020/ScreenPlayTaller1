...
public class SeleccionarDay implements Interaction {

    private Target lista;
    private String opcion;

    private SeleccionarDay(Target lista, String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    ...
    public static SeleccionarDay laLista(Target lista, String opcion) {
        return new SeleccionarDay(lista,opcion);
    }
